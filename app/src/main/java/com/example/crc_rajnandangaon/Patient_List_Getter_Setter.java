...
public class Patient_List_Getter_Setter {
    String reg_no, patient_name, father_name,
           age, gender, contact_no,
           occupation, address, referred_by,
           referred_to, chief_complaints;

    public Patient_List_Getter_Setter(String reg_no, String patient_name, String father_name, String age, String gender, String contact_no, String occupation, String address, String referred_by, String referred_to, String chief_complaints) {
        this.reg_no = reg_no;
